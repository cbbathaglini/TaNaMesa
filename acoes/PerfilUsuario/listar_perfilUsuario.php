  ...
  // Sessao::getInstance()->validar();
    ...
    foreach ($arrPerfisUsuarios as $pu){
        ...
        //if(Sessao::getInstance()->verificar_permissao('editar_perfilUsuario')) {
            $html .= '<td><a href="controlador.php?action=editar_perfil_usuario&idPerfilUsuario='.Pagina::formatar_html($pu->getIdPerfilUsuario()).'"><i class="fas fa-edit "></i></a></td>';
        //}

        //if(Sessao::getInstance()->verificar_permissao('remover_perfilUsuario')) {
            $html .= ' <td><a href="controlador.php?action=remover_perfilUsuario&idPerfilUsuario=' . Pagina::formatar_html($pu->getIdPerfilUsuario()).'"><i class="fas fa-trash-alt"></a></td>';
        //}
        $html .= '</tr>';
    }
